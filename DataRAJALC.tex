...
\begin{figure}
	...
	\caption{Execution time of models and computation for different problem sizes.}
	\label{instrumentation1_1}
\end{figure}
\begin{figure}
	\includegraphics[width=\columnwidth]{instrumentation_experiment1_part2.pdf}
	\caption{Execution time of models only for different problem sizes}
...
\begin{figure}
	...
	\caption{Execution time of models only for different numbers of user constraints.}
...
\begin{figure}
	...
	\caption{Execution time of models only for different numbers of Views in the \FormatDecisions{} object.}
...
\begin{figure}
	...
	\caption{Execution time for different data dimensionality}
