...
\subsection{RAJAPerf + miniQMC}

Our first experiment examined the performance and programmer productivity impacts of \FormatDecisions{} using four benchmarks from the RAJAPerf Suite~\cite{hornung2017raja} and one based on the determinant update from the miniQMC miniapp~\cite{richards2018fy18}.
