...
This section reviews how a computation is programmed in RAJA, working with the implementation of the \textsc{3mm} kernel (i.e., three matrix multiplications) found in Listing~\ref{3MMStart}.
...
More important than the simple number of code changes when trying out new layouts is the ease of mistakes when implementing those transformations by hand. 
