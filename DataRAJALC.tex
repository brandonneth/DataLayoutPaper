...
\begin{figure}
\begin{lstlisting}[caption={Algorithm for constructing decision space and constraints.\todo{show the ilp set formulation instead of the code.}},label={SpaceAndConstraints}]
...
\begin{figure}
	...
	\caption{Box plot showing execution times for 4-dimensional loop accessing 3-dimensional view, grouped by access order. Each point represents a different combination of policy, layout, and argument orders. Each access order group is jittered.}
