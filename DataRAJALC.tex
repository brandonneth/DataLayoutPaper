...
The problem of inter-loop optimization has spawned a number of approaches. 
Some approaches develop compiler-based heuristics\todo{cite}.
Others develop domain specific languages and libraries that expose some level of inter-loop optimization to the programmer \todo{cite}. 


, motivating a variety of approaches~\cite{ragan-kelley2013halide,mullapudi2015polymage,sujeeth2014delite,luporini2018design}.
...
\todo{Describe each benchmark in detail}
